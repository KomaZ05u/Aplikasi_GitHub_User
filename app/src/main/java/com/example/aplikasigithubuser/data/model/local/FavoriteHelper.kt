...
import com.example.aplikasigithubuser.data.model.local.DatabaseContract.FavoriteColumns.Companion.AVATAR
import com.example.aplikasigithubuser.data.model.local.DatabaseContract.FavoriteColumns.Companion.HTML
import com.example.aplikasigithubuser.data.model.local.DatabaseContract.FavoriteColumns.Companion.ID
import com.example.aplikasigithubuser.data.model.local.DatabaseContract.FavoriteColumns.Companion.LOGIN
...
class FavoriteHelper(context: Context) {
    ...
    private lateinit var listFav: ResponseDetailUser
